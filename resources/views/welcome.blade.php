...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            #bg 
            {
                ...
                flex-direction: row;
                position: relative;
                background-image: url("{{ asset('img') }}/homebg1.jpg");
    ...
    <div id="bg">
        ...
        <div id="homepageOptions">
            <a id="viewEngravings" href="{{ route('engravings.index') }}">View Engravings</a>
            <a id="newEngraving" href="{{ route('engravings.create') }}">New Engraving</a>
        </div>
